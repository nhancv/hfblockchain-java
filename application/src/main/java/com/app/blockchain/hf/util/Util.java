...
package org.app.blockchain.hf.util;
...
public class Util {
	...
	public static org.app.blockchain.hf.user.UserContext readUserContext(String affiliation, String username) throws Exception {
		...
		if (file.exists()) {
			...
			org.app.blockchain.hf.user.UserContext uContext = (org.app.blockchain.hf.user.UserContext) in.readObject();
	 ...
	 */
	public static org.app.blockchain.hf.user.CAEnrollment getEnrollment(String keyFolderPath, String keyFileName, String certFolderPath, String certFileName)
		...
		org.app.blockchain.hf.user.CAEnrollment enrollment = new org.app.blockchain.hf.user.CAEnrollment(key, certificate);
		return enrollment;
	}
