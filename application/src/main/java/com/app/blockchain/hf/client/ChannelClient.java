...
public class ChannelClient {
	...
	String name;
	Channel channel;
	org.app.blockchain.hf.client.FabricClient fabClient;
	...
	public org.app.blockchain.hf.client.FabricClient getFabClient() {
		return fabClient;
	}
	 ...
	 * @param fabClient
	 */
	public ChannelClient(String name, Channel channel, org.app.blockchain.hf.client.FabricClient fabClient) {
		this.name = name;
